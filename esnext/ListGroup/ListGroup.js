...
const ListGroup = elementFactory('ListGroup', props => {
  const child = Children.toArray(props.children)[0]; // We have to be careful of children like text nodes with this check
...
const ListGroupItem = elementFactory('ListGroupItem', ({
  active,
  color,
  ...rest
}) => {
