...
/** Active context */
export const ActiveCtx = /*#__PURE__*/createContext({
  active: false,
  guid: 'DEFAULT',
  activate: () => {},
 ...
 */
export function activeContainerBuilder(displayName, defaultProps = {}) {
  ...
  function ActiveContainer(props) {
    ...
    const handleActivate = activate || function _activate(e) {
    ...
    const handleDeactivate = useCallback(evt => {
      if (deactivate) {
        deactivate(evt);
      } else {
    ...
    const updateEventListeners = useCallback(updateType => {
