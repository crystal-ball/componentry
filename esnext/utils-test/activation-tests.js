...
export default (TestComponent => {
  ...
  test('should update arias when trigger is activated', () => {
    const wrapper = mount( /*#__PURE__*/React.createElement(TestComponent, null, /*#__PURE__*/React.createElement(TestComponent.Trigger, {
      "data-test": "trigger"
  ...
  test('should call user event hooks', () => {
    ...
    const wrapper = mount( /*#__PURE__*/React.createElement(TestComponent, {
  ...
  test('should expose internals using FaCC pattern', () => {
    const wrapper = mount( /*#__PURE__*/React.createElement(TestComponent, null, ({
      active,
      activate,
      deactivate
