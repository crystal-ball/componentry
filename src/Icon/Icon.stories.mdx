...
<DocsTitle title="Icons" experimental/>
...
<h1 className="heading-1 d-flex">
  <Icon id="code" />Great alignment yay
</h1>

<h1 className="heading-2 d-flex">
  <Icon id="code" />Great alignment yay
</h1>

<h1 className="heading-3 d-flex">
  <Icon id="code" />Great alignment yay
</h1>

<h1 className="heading-4 d-flex">
  <Icon id="code" />Great alignment yay
</h1>

## Font baseline adjustment

Checkmate... Hey, you know how I'm, like, always trying to save the planet? Here's my chance<Icon id="award" font />.They're using our own satellites against us. And the clock is ticking. Must go faster... go, go, go, go, go! I was part of something special. Remind me to thank John for a lovely weekend.
