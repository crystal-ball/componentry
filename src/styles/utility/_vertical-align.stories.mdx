...
import { alignments } from '../../storybook-resources'

<Meta title='Utility Classes/Vertical Align' />

<DocsTitle title='Vertical align' experimental />

<div className='border border-300 border-radius p-3 w-100'>
  <p
    className='vertical-align-guides text-lg'
    style={{ fontWeight: 300, textDecoration: 'underline overline' }}
  >
