...
import { Flex, Button, Link, Text, Theme } from '.'

<Meta title='Componentry/Intro' />

<Flex align='center' direction='column' mt={4}>
  <svg viewBox='0 0 970 796' width={360} height={295}>
  ...
  <Text variant='h1'>Componentry</Text>
</Flex>

<Flex align='center' direction='column' mt={4}>
  <Text variant='h3'>Storybook usage</Text>
  <Text className='w-1/2 text-justify'>
    This Storybook is used for development and testing purposes. Documentation in these
    stories is focused on technical details. Library documentation is maintained at{' '}
    <Link href='https://componentry.design'>https://componentry.design</Link>
  </Text>
</Flex>
