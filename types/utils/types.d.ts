 ...
 */
export declare type MergePropTypes<Defaults, Overrides> = {
    [Prop in keyof Defaults]: Prop extends keyof Overrides ? Overrides[Prop] : Defaults[Prop];
};
 ...
 */
export declare type ComponentBaseProps<Element extends React.ElementType> = {
    /** Component element */
...
} & MergePropTypes<DefaultUtilityProps, UtilityProps> & Omit<React.ComponentPropsWithoutRef<Element>, 'className'>;
