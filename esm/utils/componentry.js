...
function generateClassNames(p) {
  ...
  return _ref = {
    ...
    'italic': p.italic,
    'visible': p.visible
  }, _defineProperty(_ref, String(p.position), p.position), _defineProperty(_ref, String(p.textTransform), p.textTransform), _defineProperty(_ref, "bg-".concat(p.backgroundColor), p.backgroundColor), _defineProperty(_ref, "border-".concat(p.borderColor), p.borderColor), _defineProperty(_ref, "border-".concat(p.borderWidth), p.borderWidth), _defineProperty(_ref, "content-".concat(p.alignContent), p.alignContent), _defineProperty(_ref, "font-".concat(p.fontFamily), p.fontFamily), _defineProperty(_ref, "font-".concat(p.fontWeight), p.fontWeight), _defineProperty(_ref, "items-".concat(p.alignItems), p.alignItems), _defineProperty(_ref, "justify-".concat(p.justifyContent), p.justifyContent), _defineProperty(_ref, "self-".concat(p.alignSelf), p.alignSelf), _defineProperty(_ref, "text-".concat(p.fontColor), p.fontColor), _defineProperty(_ref, "text-".concat(p.fontSize), p.fontSize), _defineProperty(_ref, "text-".concat(p.textAlign), p.textAlign), _ref;
}
 ...
 */
export function componentry(_ref2) {
  var __precompile = _ref2.__precompile,
      ...
      filteredProps = _objectWithoutProperties(_ref2, _excluded);
  ...
  Object.keys(filteredProps).forEach(function (prop) {
    ...
    !['xs', 'sm', 'md', 'lg', 'xl'].includes(filteredProps[prop])) {
      ...
      if (['xs', 'sm', 'md', 'lg', 'xl'].includes(filteredProps[prop])) {
        ...
        var _spacingMatch = _slicedToArray(spacingMatch, 3),
            b = _spacingMatch[1],
            m = _spacingMatch[2];
