...
/** Media Context */
var MediaCtx = /*#__PURE__*/createContext(null); // Default breakpoint values
 ...
 * @experimental
 */
export function Media(_ref) {
  var children = _ref.children,
      _ref$breakpoints = _ref.breakpoints,
      breakpoints = _ref$breakpoints === void 0 ? [sm, md, lg] : _ref$breakpoints;

  var _useState = useState(calcBreakpoints(breakpoints)),
