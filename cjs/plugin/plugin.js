      ...
      JSXElement: function JSXElement(path) {
        ...
        var _parseAttributes = (0, _parseAttributes2.parseAttributes)(attributes, t, {
          name: name
            ...
            parseSuccess = _parseAttributes.parseSuccess; // If we weren't able to successfully parse all of the node attributes bail early
        ...
        path.get('openingElement').replaceWith((0, _buildElements.buildOpeningElement)(precompiledComponent, openingElement.selfClosing, t));
